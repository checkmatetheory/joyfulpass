 ...
 * The Britizen-style layout the whole app family follows: a persistent sidebar
 * plus a route-picker of cards (Practice + Study Materials) that link deeper
 * into each subcategory. The informative, app-store-driving content (About the
 * test, how to prepare, FAQ) sits below the cards.
 */
      ...
      <main className="min-w-0 flex-1 px-5 py-8 sm:px-10">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-2 max-w-2xl opacity-70">
            Free practice organised the way the official handbook is. Pick how you want to
            study — every route below is built from the official material.
          </p>
